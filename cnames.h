...
struct cnames Cnames[] = {
	...
	{"again",			ZAGAIN,			H_SEARCH,
	 ...
	 "set,\n the search will be case sensitive. A Universal Argument"
	 "causes the\n search to look for an exact number matches of the"
	 "string. If the number\n cannot be matched, it will display the"
	 "number actually matched in the\n PAW and leave the Point where it"
	 "was. If no search commands have been\n executed, a Forward Search is"
	 "executed.\n"
	},
	...
	{"arg",				ZARG,			H_OTHER,
	 ...
	 "command to\n repeat or to modify the meaning of the command in some"
	 "way. It reads\n decimal digits and displays them in the PAW. The"
	 "first non-digit is\n processed as a command. The digits cannot be"
	 "deleted since Delete is a\n valid command that accepts a Universal"
	 "Argument. If a mistake is made,\n use the Abort Command.\n"
	},
	...
	{"beginning-of-line",		ZBEGINNING_OF_LINE,	H_CURSOR,
	 ...
	 "the\n previous line. A Universal Argument causes the command to"
	 "repeat.\n"
	},
	{"bind",			ZBIND,			H_BIND,
	 "Binds a function to a key. It first prompts, with command"
	 "completion,\n for the command to bind. It then prompts for the key"
	 "to bind the command\n to. The Meta and C-X prefix keys are entered,"
	 "Bind prompts for another\n key. The Abort command exits any"
	 "prompt. The Quote command can be used\n to rebind the Abort, Quote,"
	 "C-X, and Meta commands. A Universal Argument\n causes the Bind"
	 "command to reset all the default arguments.  Keys can be\n 'unbound'"
	...
	{"c-indent",			ZC_INDENT,		H_MODE,
	 ...
	 "level. If a\n Newline is hit after an open brace ({), the next line"
	 "is indented an\n extra tab stop. Bound to Newline in C mode. A"
	 "Universal Argument causes\n the command to repeat.\n"
	},
	{"c-insert",			ZC_INSERT,		H_SPECIAL,
	 "Tries to perform brace matching. When a close brace (}) is"
	 "entered,\n searches for a previous unmatched open brace ({). If it"
	 "finds one, tries\n to put the close brace in the same column as the"
	 "column of the first\n non-whitespace character in the matched"
	 "line. If no match is found,\n beeps. Bound to close brace in C"
	 "mode. If bound to a character other than\n a close brace, performs a"
	 "Character Insert. A Universal Argument is\n ignored.\n"
	},
	{"calc",			ZCALC,			H_HELP,
	 ...
	 "is\n assumed to be hexadecimal, if it begins with a '0' it is"
	 "assumed to be\n octal, all others are assumed to be decimal. The"
	 "output is displayed in\n decimal with hexadecimal in brackets"
	 "'()'. Spaces and tabs are allowed\n but are not necessary between"
	 "the numbers and their operators. A Universal\n Argument is"
	 "ignored.\n"
	},
	{"capitalize-word",		ZCAPITALIZE_WORD,	H_DISP,
	 "In C mode, converts the character at the Point to uppercase and the"
	 "rest\n of the word to lowercase. In other modes, converts the first"
	 "letter of\n the current word to uppercase and the rest of the"
	 "characters in the word\n to lowercase. The Point is left at the end"
	 "of the word. A Universal\n Argument causes the command to repeat.\n"
	},
	{"center",			ZCENTER,		H_DISP,
	 "Centers the current line on the screen. It uses FillWidth to define"
	 "the\n right margin. A Universal Argument causes the command to"
	 "repeat on the\n next lines.\n"
	},
	{"cmd-to-buffer",		ZCMD_TO_BUFFER,		H_SHELL,
	 ...
	 "shell. The\n output is put in the '.shell' buffer. Any previous"
	 "contents of the\n '.shell' buffer are deleted. A Universal Argument"
	 "is ignored.\n"
	},
	{"copy-region",			ZCOPY_REGION,		H_DELETE,
	 "Copies the region to the kill buffer. The kill buffer is"
	 "overwritten\n unless the the delete flag is set. See Append Kill"
	 "command.\n"
	},
	{"copy-word",			ZCOPY_WORD,		H_DELETE,
	 "Copies the word the Point is on to the kill buffer. The kill buffer"
	 "is\n overwritten unless the the delete flag is set.In the PAW, the"
	 "Copy Word\n command takes the word the Point was on in the"
	...
	{"cwd",				ZCWD,			H_OTHER,
	 ...
	 "directory. All\n files will be relative to the new working"
	 "directory. The default is the\n directory the editor was started"
	 "in. A Universal Argument causes the\n command to repeat.\n"
	},
	{"delete-blanks",		ZDELETE_BLANKS,		H_DELETE,
	 "Delete all the blank lines around the Point. The lines are not put"
	 "in\n the Kill Buffer. A Universal Argument causes the command to"
	 "repeat,\n which accomplishes nothing.\n"
	},
	{"delete-buffer",		ZDELETE_BUFFER,		H_BUFF,
	 "Deletes the current buffer and goes to a previous buffer. There"
	 "must\n always be at least one buffer. If the buffer has been"
	 "modified, Zedit\n asks to save it before deleting it. A Universal"
	 "Argument prompts for the\n buffer to delete.\n"
	},
	{"delete-char",			ZDELETE_CHAR,		H_DELETE,
	 "Deletes the character at the Point and leaves the Point on the"
	 "next\n character in the buffer. The character is not put in the Kill"
	...
	{"delete-line",			ZDELETE_LINE,		H_DELETE,
	 ...
	 "the\n Point is in the line. The Point is left at the start of the"
	 "next line.\n The deleted line is put in the Kill Buffer. A Universal"
	 "Argument causes\n the command to repeat.\n"
	},
	{"delete-previous-char",	ZDELETE_PREVIOUS_CHAR,	H_DELETE,
	 "Deletes the character before the Point and leaves the Point in the"
	 "same\n place. The character is not put in the Kill Buffer. A"
	...
	{"delete-previous-word",	ZDELETE_PREVIOUS_WORD,	H_DELETE,
	 ...
	 "is on\n is not deleted. The word is put in the Kill Buffer. A"
	 "Universal Argument\n causes the command to repeat.\n"
	},
	{"delete-region",		ZDELETE_REGION,		H_DELETE,
	 "Deletes the characters in the region. The deleted characters are put"
	 "in\n the Kill Buffer based on the delete flag. A Universal Argument"
	 "is\n ignored.\n"
	},
	{"delete-to-eol",		ZDELETE_TO_EOL,		H_DELETE,
	 "Deletes the characters from the Point to the end of the line. If"
	 "the\n Point is at the end of a line, the Newline character is"
	 "deleted and the\n next line is joined to the end of the current"
	 "line. The characters\n deleted are put in the Kill Buffer. A"
	 "Universal Argument causes the\n command to repeat.\n"
	},
	...
	{"delete-word",			ZDELETE_WORD,		H_DELETE,
	 ...
	 "is\n put in the Kill Buffer. A Universal Argument causes the command"
	 "to\n repeat.\n"
	},
	...
	{"exit",			ZEXIT,			H_OTHER,
	 ...
	 "bang\n (!) saves all remaining buffers. A Universal Argument causes"
	...
	{"fill-check",			ZFILL_CHECK,		H_SPECIAL,
	 ...
	 "the\n words past or on the FillWidth column are wrapped. This gives"
	 "some word\n processing capability to the editor. Normally bound to"
	 "the space bar and\n Newline only in Text Mode. A Universal Argument"
	 "has no meaning.\n"
	},
	{"fill-paragraph",		ZFILL_PARAGRAPH,	H_MODE,
	 "Uses the FillWidth to reformat the paragraph the Point is in. This"
	 "is\n useful if editing has messed up the right margin. A Universal"
	 "Argument\n reformats the next Arg paragraphs. A Universal Argument"
	 "of 0 reformats\n the entire buffer. When reformatting the entire"
	 "buffer, hitting a\n character will abort the reformat. Not allowed"
	 "in program mode buffers.\n"
	},
	{"find-file",			ZFIND_FILE,		H_FILE,
	 "Prompts for a path name. If a buffer already exists with this path"
	 "name,\n that buffer is switched to. If no buffer is matched, a new"
	 "buffer is\n created and the file read into it. Supports file name"
	 "completion. A\n Universal Argument causes the command to repeat.\n"
	},
	{"global-re-search",		ZGLOBAL_RE_SEARCH,	H_SEARCH,
	 "This command is used to search for a regular expression in all the"
	 "buffers.\n It prompts for a search string and then starts searching"
	 "at the start of\n the first buffer. If a match is found, it stops"
	 "and leaves the point at\n the match. If Again is executed, it starts"
	 "at the current Point and\n searches forwards through the buffers. At"
	 "the last buffer it stops and\n puts the Point back where it"
	...
	{"global-search",		ZGLOBAL_SEARCH,		H_SEARCH,
	 ...
	 "of\n the first buffer. If a match is found, it stops and leaves the"
	 "point at\n the match. If Again is executed, it starts at the current"
	 "Point and\n searches forwards through the buffers. At the last"
	 "buffer it stops and\n puts the Point back where it started. A"
	 "Universal Argument is ignored.\n"
	},
	{"goto-line",			ZGOTO_LINE,		H_CURSOR,
	 "Moves the point to the start of a given line. If there is a"
	 "Universal\n Argument, uses the argument, else prompts for the line"
	 "number. If the\n line is past the end of the buffer, moves the Point"
	 "is left at the end\n of the buffer.\n"
	},
	{"grep",			ZGREP,			H_SHELL,
#if !SHELL
	...
	{"grow-window",			ZGROW_WINDOW,		H_BUFF,
	 ...
	 "inactive\n window one line smaller. A window cannot be less than"
	 "three (3) lines.\n If there is only one window, this command has no"
	 "effect. A Universal\n Argument causes the command to grow the window"
	...
	{"incremental-search",		ZINCREMENTAL_SEARCH,	H_SEARCH,
	 ...
	 "PAW. The\n Delete Previous Character command can be used to delete a"
	 "character and\n 'back up' the search. The Newline character"
	 "terminates the search. The\n Abort command terminates the search and"
	 "places the Point back where it\n was. Any other commands terminates"
	 "the search and performs that command.\n A Universal Argument causes"
	 "the command to repeat.\n"
	},
	...
	{"insert",			ZINSERT,		H_SPECIAL,
	 ...
	 "be\n inserted in the buffer. A Universal Argument causes the command"
	 "to\n repeat.\n"
	},
	{"insert-overwrite",		ZINSERT_OVERWRITE,	H_MODE,
	 "Toggles the current buffers minor mode between Insert, the default,"
	 "and\n overwrite modes. On the PC the cursor shape reflects the"
	 "mode. Insert\n mode has an underline cursor while overwrite mode has"
	 "a block cursor. A\n Universal Argument is ignored.\n"
	},
	{"join",			ZJOIN,			H_DELETE,
	...
	{"key-binding",			ZKEY_BINDING,		H_BIND,
	 ...
	 "in the\n PAW. Handles C-X and M- prefixes. A Universal Argument is"
	 "ignored.\n"
	},
	{"kill",			ZKILL,			H_SHELL,
#if !SHELL
	...
	{"life",			ZLIFE,			H_OTHER,
	 ...
	 "space does the next iteration.\n A Return causes continuous"
	 "iterations (with a slight delay).\n An Abort stops the game.\n"
	},
	...
	{"lowercase-word",		ZLOWERCASE_WORD,	H_DISP,
	 ...
	 "leaves\n the Point at the end of the word. A Universal Argument"
	 "causes the\n command to repeat.\n"
	},
	{"make",			ZMAKE,			H_SHELL,
#if !SHELL
	 ...
	 "and\n puts the output in the '.make' buffer. The command is usually"
	 "'make' and\n is used in conjunction with the Next Error command. A"
	...
	{"mark-paragraph",		ZMARK_PARAGRAPH,	H_DELETE,
	 ...
	 "Point\n to the start of the next paragraph. A Universal Argument"
	 "causes the\n command to repeat.\n"
	},
	...
	{"meta-x",			ZMETA_X,		H_OTHER,
	 ...
	 "in\n this manner. Supports command completion. A '?' will show all"
	 "the\n possible matches. A Universal Argument is passed on to the"
	 "selected\n command.\n"
	},
	{"mode",			ZMODE,			H_MODE,
	 "Change the mode of the current buffer. Prompts (with command"
	 "completion)\n for the mode to change to.  A Universal Argument"
	 "causes multiple\n toggles.\n"
	},
	{"newline",			ZNEWLINE,		H_SPECIAL,
	 "The command normally bound to the Enter or Return key.\n In"
	 "overwrite mode, a NL goes to start of next line.\n In insert mode,"
	 "its just inserted.\n A Universal Argument causes the command to"
	 "repeat.\n"
	},
	{"next-bookmark",		ZNEXT_BOOKMARK,		H_CURSOR,
	 ...
	 "Argument\n in the range 1 to 10 corresponding to a set bookmark will"
	 "go to the\n bookmark.\n"
	},
	{"next-buffer",			ZNEXT_BUFFER,		H_BUFF,
	 "Switches to the next buffer in the buffer list. At the end of the"
	 "list,\n it switches to the first buffer in the list, i.e. treats the"
	 "list like a\n ring. A Universal Argument causes the command to"
	 "repeat.\n"
	},
	{"next-char",			ZNEXT_CHAR,		H_CURSOR,
	 "Moves the Point forward one character. If the Point is at the end of"
	 "a\n line, it is moved to the start of the next line. A Universal"
	 "Argument\n causes the command to repeat.\n"
	},
	{"next-error",			ZNEXT_ERROR,		H_SHELL,
	 ...
	 "'.make'\n buffer. If an error is found, the Mark in the '.make'"
	 "buffer is placed\n at the start of the error message. The file"
	 "containing the error is\n loaded into a buffer using the Find File"
	 "command and the Point is placed\n at the error line.\n If a"
	...
	{"next-line",			ZNEXT_LINE,		H_CURSOR,
	 ...
	 "same\n column position. If the line is to short the, Point will be"
	 "the placed\n at the end of the line. Consecutive Previous/Next Line"
	 "or Page commands\n try to maintain the original column position. A"
	 "Universal Argument\n causes the command to repeat.\n"
	},
	{"next-page",			ZNEXT_PAGE,		H_CURSOR,
	 "Moves the Point down one page and tries to center the Point line in"
	 "the\n display. It tries to maintain the same column position. If the"
	 "line is\n to short the, Point will be the placed at the end of the"
	 "line.\n Consecutive Previous/Next Line or Page commands try to"
	 "maintain the\n original column position. A Universal Argument causes"
	 "the command to\n repeat.\n"
	},
	...
	{"next-window",			ZNEXT_WINDOW,		H_DISP,
	 ...
	 "a\n circular list. A Universal Argument goes to the Nth next"
	 "window.\n"
	},
	...
	{"open-line",			ZOPEN_LINE,		H_DISP,
	 ...
	 "the\n Newline. It is the same as typing a Newline and then a"
	 "Previous\n Character command. A Universal Argument causes the"
	 "command to repeat.\n"
	},
	{"other-next-page",		ZOTHER_NEXT_PAGE,	H_BUFF,
	 "Performs a Next Page command in the bottom window or the top window"
	 "if\n you are in the bottom window. It leaves the Point where it is"
	 "in the\n active window. If there is only one window, this command"
	 "has no effect.\n A Universal Argument causes the command to page the"
	 "Nth window.\n"
	},
	{"other-previous-page",		ZOTHER_PREVIOUS_PAGE,	H_BUFF,
	 "Performs a Previous Page command in the bottom window or the top"
	 "window\n if you are in the bottom window. It leaves the Point where"
	 "it is in the\n active window. If there is only one window, this"
	 "command has no effect.\n A Universal Argument pages the Nth"
	 "window.\n"
	},
	{"out-to",			ZOUT_TO,		H_CURSOR,
	 "This command moves the Point to an absolute column position. If the"
	 "line\n is shorter than the specified column, it is padded with tabs"
	 "and spaces\n to the specified column. The command takes either a"
	 "Universal Argument or\n prompts for the column to go to.\n"
	},
	{"position",			ZPOSITION,		H_HELP,
	 "Displays the current Point position as a line, column, and byte"
	 "offset\n in the echo window. Also displays the length of the"
	 "buffer. A Universal\n Argument is ignored.\n"
	},
	{"previous-char",		ZPREVIOUS_CHAR,		H_CURSOR,
	 "Moves the Point back one character. If the Point is at the start of"
	 "the\n line, it is moved to the end of the previous line. A Universal"
	 "Argument\n causes the command to repeat.\n"
	},
	{"previous-line",		ZPREVIOUS_LINE,		H_CURSOR,
	 "Moves the Point up one line in the buffer. It tries to maintain the"
	 "same\n column position. If the line is to short, the Point will be"
	 "placed at\n the end of the line. Consecutive Previous/Next Line or"
	 "Page commands try\n to maintain the original column position. A"
	 "Universal Argument causes\n the command to repeat.\n"
	},
	{"previous-page",		ZPREVIOUS_PAGE,		H_CURSOR,
	 "Moves the Point up one page and tries to center the Point line in"
	 "the\n display. It tries to maintain the same column position. If the"
	 "line is\n to short, the Point will be placed at the end of the"
	 "line. Consecutive\n Previous/Next Line or Page commands try to"
	 "maintain the original column\n position. A Universal Argument causes"
	 "the command to repeat.\n"
	},
	{"previous-paragraph",		ZPREVIOUS_PARAGRAPH,	H_CURSOR,
	 "Moves the Point to the start of the paragraph or to the start of"
	 "the\n previous paragraph. A Universal Argument causes the command to"
	 "repeat.\n"
	},
	{"previous-window",		ZPREVIOUS_WINDOW,	H_DISP,
	 "Goes to the previous window on the screen. The windows are treated"
	 "as a\n circular list. A Universal Argument goes to the Nth previous"
	 "window.\n"
	},
	...
	{"query-replace",		ZQUERY_REPLACE,		H_SEARCH,
	 ...
	 "from the\ncurrent Point looking for matches of the search string. "
	 "If it finds a\nmatch, it moves the Point to the match and waits for "
	 ...
	 "Replace. If\nthe mode Exact is set, the search will be case "
	 "sensitive. A Universal\nArgument causes the replacement to be "
	 "done globally in all the buffers.\n"
	},
	{"quote",			ZQUOTE,			H_OTHER,
	 "The Quote command is used to insert a character into a buffer or"
	 "String\n Argument that would normally be a command. The next"
	 "character after the\n Quote command is taken literally, unless the"
	 "key is a valid hexadecimal\n digit. If the key is a valid"
	 "hexadecimal digit, it and the next key are\n taken together as a"
	 "hexadecimal number and the ASCII character\n equivalent of this"
	 "number is inserted into the buffer. If a key is not\n hit within"
	...
	{"re-replace",			ZRE_REPLACE,		H_SEARCH,
	 ...
	 "is a\n regular expression. The replacement string is a literal with"
	 "two\n exceptions. An '&' character causes the matched string to be"
	 "placed in\n the buffer. The escape character '\' can be used to turn"
	 "off this\n special meaning of '&'. Note that '\\' is required to put"
	 "a real '\' in\n the buffer. For each match, a prompt is made for the"
	 "action to perform.\n See Query Replace for a list of valid"
	 "actions. A Universal\n Argument causes the replacement to be done"
	...
	{"re-search",			ZRE_SEARCH,		H_SEARCH,
	 ...
	 "Point\n forward for a match in the buffer. If a match is found, the"
	 "Point is\n moved to the start of the match. If the string is not"
	 "found, then 'Not\n Found' is displayed in the echo window and the"
	 "Point is left where it\n was. The search string is saved and"
	 "subsequent search and replace\n commands will default to this"
	 "string. If the mode Exact is set, the\n search will be case"
	 "sensitive. A Universal Argument causes the search\n to look for"
	...
	{"read-file",			ZREAD_FILE,		H_FILE,
	 ...
	 "the\n file into the current buffer before the Point. If there is a"
	 "Universal\n Argument, the current buffer is deleted, first asking to"
	 "save the file\n if it is modified, before reading in the new"
	 "file. The buffers file name\n is not changed, any writes will be to"
	 "the old file name.\n"
	},
	...
	{"replace",			ZREPLACE,		H_SEARCH,
	 "Prompts for a search string and a replacement string and searches"
	 "from\n the current Point looking for matches of the search"
	 "string. If it finds\n a match, it replaces the string and"
	 "continues. The Point is left at the\n position it was in before the"
	 "Query Replace. If the mode Exact is set,\n the search will be case"
	 "sensitive. A Universal Argument causes the\n replacement to be done"
	 "globally in all the buffers.\n"
	},
	...
	{"reverse-search",		ZREVERSE_SEARCH,	H_SEARCH,
	 ...
	 "a\n match in the buffer. If a match is found, the Point is moved to"
	 "the\n start of the match. If the string is not found, then 'Not"
	 "Found' is\n displayed in the echo window and the Point is not"
	 "moved. The search\n string is saved and subsequent search and"
	 "replace commands will default\n to the last search string. If the"
	 "mode Exact is set, the search will be\n case sensitive. A Universal"
	 "Argument causes the search to look for\n exactly Arg matches of the"
	 "String Argument.\n"
	},
	{"revert-file",			ZREVERT_FILE,		H_FILE,
	 "Rereads the current file. If the file has changed, asks to"
	 "overwrite\n changes. A Universal Argument causes multiple"
	 "rereads. Mimics the vi 'e'\n command.\n"
	},
	...
	{"save-bindings",		ZSAVE_BINDINGS,		H_BIND,
	 ...
	 "is\n saved in the users home directory. A Universal Argument causes"
	 "Arg\n saves!\n"
	},
	{"save-file",			ZSAVE_FILE,		H_FILE,
	 "Saves the current buffer to its file. If the current buffer has no"
	 "path\n name, a path name is prompted for (with file name"
	 "completion). A\n Universal Argument is ignored.\n"
	},
	...
	{"search",			ZSEARCH,		H_SEARCH,
	 ...
	 "the\n start of the match. If the string is not found, then 'Not"
	 "Found' is\n displayed in the echo window and the Point is not"
	 "moved. The search\n string is saved and subsequent search or replace"
	 "commands will default\n to the last search string. If the mode Exact"
	 "is set, the search will be\n case sensitive. A Universal Argument"
	 "causes the search to look for\n exactly Arg matches.\n"
	},
	...
	{"set-variable",		ZSET_VARIABLE,		H_HELP,
	 ...
	 "completion\n is supported. Prompts for the variable, then prompts"
	 "for the new\n setting. A Universal Argument causes numeric or flag"
	 "variables to be\n set to Arg, string variables ignore the Universal"
	 "Argument.\n"
	},
	...
	{"split-window",		ZSPLIT_WINDOW,		H_BUFF,
	 ...
	 "displayed in\n both windows and the bottom window is made active. A"
	...
	{"swap-chars",			ZSWAP_CHARS,		H_DISP,
	 ...
	 "the\n end of the line. If the Point was at the end of a line, the"
	 "two\n characters before the Point are transposed. If the Point is at"
	 "the\n beginning of the buffer, the character at the Point and the"
	 "character\n after the Point are transposed. A Universal Argument"
	 "causes the command\n to repeat.\n"
	},
	...
	{"swap-words",			ZSWAP_WORDS,		H_DISP,
	 ...
	 "after\n the second word. Successive commands will 'drag' the word"
	 "before the\n Point towards the end of the line. If the Point is at"
	 "the end of a line,\n the last word on the line is transposed with"
	 "the first word on the next\n line. The command does nothing at the"
	 "end of the buffer. If the Point is\n in the middle of a word, the"
	 "two halves of the word are transposed. A\n Universal Argument causes"
	 "the command to repeat.\n"
	},
	{"switch-to-buffer",		ZSWITCH_TO_BUFFER,	H_BUFF,
	 ...
	 "allows\n quick switching between two buffers. The Again command can"
	 "be used to\n scroll through the buffer list. A Universal Argument is"
	 "ignored.\n"
	},
	{"tab",				ZTAB,			H_SPECIAL,
	...
	{"toggle-case",			ZTOGGLE_CASE,		H_SEARCH,
	 ...
	 "case\n insensitive for searches and replacements. Ignores the"
	 "Universal\n Argument.\n"
	},
	{"trim-white-space",		ZTRIM_WHITE_SPACE,	H_DELETE,
	 "Removes all spaces and tabs on both sides of the Point. The Point"
	 "is\n left on the character that is to the right of the deleted"
	 "text. The\n deleted characters are not put in the Kill Buffer. A"
	 "Universal Argument\n is ignored.\n"
	},
	...
	{"write-file",			ZWRITE_FILE,		H_FILE,
	 ...
	 "file\n name. Supports file name completion. It changes the path name"
	 "of the\n current buffer to the new path name. A Universal Argument"
	 "causes only\n the Region to be written and does not change the name"
	 "of the buffer.\n"
	},
	{"yank",			ZYANK,			H_DELETE,
