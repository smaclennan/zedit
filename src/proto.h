...
void Bind NOARGS;
Boolean Bindfile ARGS((char*, int));
Boolean Bindone ARGS((char*, int, int*));
void Binit NOARGS;
...
void Setregion ARGS((int (*convert)()));
